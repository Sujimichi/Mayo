...
While it is possible to run several instances of cucumber on the same machine from within different directories, there is a positive correlation between number of instances and number of "false-failing" tests.
